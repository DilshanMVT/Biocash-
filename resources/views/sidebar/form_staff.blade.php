            ...
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item">
                            <a href="{{ route('otherBankTransaction') }}">Otherbank Transactions</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('billPaymentTransaction') }}">Bill payment</a>
                        </li>
                    </ul>
                </li>
                @if (Auth::user()->role_name == 'Super Admin')
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('form/view/detail') }}">Transactions history</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
